<!--<?php echo validation_errors() ; ?>-->
  ...
  <div class="col-md-8 col-md-offset-2">
    ...
    <!--<div class="panel-heading"><h4><strong>Ingresar nuevo trabajo</strong></h4></div>-->
      ...
      <?php echo form_open('trabajos/new_trabajo','role="form" class="form-horizontal"') ; ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <?php echo form_dropdown('tip_trabajo',$tip_trabajo,set_value('tip_trabajo'),$attributes); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <?php echo form_dropdown('vendedor',$vendedor,set_value('vendedor'),$attributes); ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <?php echo form_dropdown('cliente',$cliente,set_value('cliente'),$attributes); ?>
